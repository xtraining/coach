...
function save(){
	...
	$.ajax({
			type:'POST',
			url:'${ctx}/coach/org/createCoach.htm',
...
<div class="pageContent">
	...
	<h2 class="contentTitle">教练信息</h2>
		<div class="pageFormContent nowrap" layoutH="96">	
			<dl>
				<dt>教练姓名：</dt>
				<dd><input type="text" name="coachName" size="60" class="required" maxlength="128"/></dd>
			</dl>
			<dl>
				<dt>证据类型：</dt>
				<dd>
			...
			<dl>
				<dt>证据号码: </dt>
				<dd><input type="text" name="idNumber" size="60" class="required" maxlength="128"/></dd>
			</dl>	
		</div>
		<div class="formBar">
			<ul>
