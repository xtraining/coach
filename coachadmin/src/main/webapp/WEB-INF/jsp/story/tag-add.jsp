...
function save(){
	...
	$.ajax({
			type:'POST',
			url:'${ctx}/story/tag/create.htm',
			data:$("#taskForm").formSerialize(),//序列化表单里所有的内容
			success: function(data){	
				switch(data){
						case "success":	
							dialogAjaxDone({"statusCode":"200", "message":"创建成功。", "navTabId":"标签管理", "forwardUrl":"", "callbackType":"closeCurrent", "rel":""});	
							break;
						default:
							dialogAjaxDone({"statusCode":"300", "message":"创建失败，请重试。", "navTabId":"标签管理", "forwardUrl":"", "callbackType":"closeCurrent", "rel":""});							
							break;	
					}
			}
			});
...
<div class="pageContent">
	...
	<h2 class="contentTitle">标签信息</h2>
		<div class="pageFormContent" layoutH="96">	
			...
			<dl>
				<dt>权重: </dt>
				<dd><input type="text" name="tagOrder" size="60" class="digits required" maxlength="128" value="0"/></dd>
			</dl>			
			<dl>
				<dt>状态： </dt>
				<dd>
