...
function save(){
	...
	$.ajax({
			type:'POST',
			url:'${ctx}/story/artifact/saveCategory.htm',
			data:$("#assignCoachForm").formSerialize(),//序列化表单里所有的内容
			success: function(data){	
			    var aaa = jQuery.parseJSON(data);
				switch(aaa){
						case "success":	
							dialogAjaxDone({"statusCode":"200", "message":"设置成功。", "navTabId":"故事管理", "forwardUrl":"", "callbackType":"closeCurrent", "rel":""});	
							break;
						case "input":	
							dialogAjaxDone({"statusCode":"300", "message":"请选择分类。", "navTabId":"故事管理", "forwardUrl":"", "callbackType":"", "rel":""});							
							break;	
						default:
