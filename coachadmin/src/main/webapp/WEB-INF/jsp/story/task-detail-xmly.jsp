...
<form id="pagerForm" method="post" action="${ctx}/story/task/detail.htm">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="NumPerPage" value="20" />
</form>

<div class="pageHeader">
	<form  name="objForm" id="objForm" rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctx}/story/task/detail.htm" method="post">
	<div class="searchBar">
