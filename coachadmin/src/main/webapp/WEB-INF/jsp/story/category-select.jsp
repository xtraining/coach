...
<form id="pagerForm" method="post" action="${ctx}/story/category/select.htm">
...
<div class="pageHeader">
	<form rel="pagerForm" method="post" action="${ctx}/story/category/select.htm" onsubmit="return dwzSearch(this, 'dialog');">
	<div class="searchBar">
