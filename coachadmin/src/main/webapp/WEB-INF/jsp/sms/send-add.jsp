...
function save(){
	...
	$.ajax({
			...
			success: function(data){	
				switch(data){
						case "\"success\"":	
							navTabAjaxDone({"statusCode":"200", "message":"Save Success.", "navTabId":"短信管理", "forwardUrl":"", "callbackType":"closeCurrent", "rel":""});	
							break;
						default:
							navTabAjaxDone({"statusCode":"300", "message":"Save Error, Please retry.", "navTabId":"Accounts", "forwardUrl":"", "callbackType":"closeCurrent", "rel":""});							
							break;	
					}
			}
			});
...
function getContact(){
	$.ajax({
			type:'POST',
			url:"${ctx}/sms/contact/getContactCount.htm?spName=" + $("#spName").val()+'&areaId='+$("#areaId").val(),
