...
public class XimalayaParser extends MyHtmlParser {
	...
	//http://www.ximalaya.com/album/286034.xml
...
//        list.add(coverDto);
        ...
        for(Element item : itemList){
             ...
             Element itemSubtitleElement = item.element("subtitle");
             artifactDto.setSubtitle(StringUtils.trim(itemSubtitleElement.getText()));
